...
@server.route("/temperature", methods = {'GET', 'POST', 'PUT','DELETE'})  # this is a REST API 
def temperature_methods():
    ...
    if request.method == 'GET':
        ...
        #return reposnse to the client
        return response.create_response("Temperature is updated successfully")
